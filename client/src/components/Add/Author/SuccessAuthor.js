...
export default function SuccessAuthor(props) {
    return (
        <div className='cont'>
            <div className="cardsuc">
                <div className="headersuc">
                    ...
                    <div className="contentsuc">
                        ...
                        <p className="message">New Author Details have been Successfully added into the records</p>
                    </div>
                    <div className="actions">
                        <Link className="history" type="button" to='/'>Home</Link>
                        <Link className="track" type="button" to='/Author'>View Author Records</Link>
                        <Link className="track" type="button" to='/AddAuthor'>Add New Author</Link>
                    </div>
                </div>
            </div>
        </div>
