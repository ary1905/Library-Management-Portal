...
export default function SuccessUser(props) {
    return (
        <div className='cont'>
            <div className="cardsuc">
                <div className="headersuc">
                    ...
                    <div className="contentsuc">
                        ...
                        <p className="message">New User Details have been Successfully added into the records</p>
                    </div>
                    <div className="actions">
                        <Link className="history" type="button" to='/'>Home</Link>
                        <Link className="track" type="button" to='/User'>View Book Records</Link>
                        <Link className="track" type="button" to='/AddUser'>Add New Book</Link>
                    </div>
                </div>
            </div>
        </div>
