...
export default function SuccessCat(props) {
    return (
        <div className='cont'>
            <div className="cardsuc">
                <div className="headersuc">
                    ...
                    <div className="contentsuc">
                        ...
                        <p className="message">New Category Details have been Successfully added into the records</p>
                    </div>
                    <div className="actions">
                        <Link className="history" type="button" to='/'>Home</Link>
                        <Link className="track" type="button" to='/Category'>View Category Records</Link>
                        <Link className="track" type="button" to='/AddCategory'>Add New Category</Link>
                    </div>
                </div>
            </div>
        </div>
